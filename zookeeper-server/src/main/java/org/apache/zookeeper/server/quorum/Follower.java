...
public class Follower extends Learner{
    ...
    void followLeader() throws InterruptedException {
        ...
        try {
            ...
            try {
                ...
                // 发送learner消息给leader， 并接受leader发送的消息，然后回复new leader ack
                ...
                while (this.isRunning()) {
                    // 成为follower后，读取leader发送的数据
                    readPacket(qp);

                    // 成为follower后，处理来自leader的请求
                    processPacket(qp);
                }
            } catch (Exception e) {
    ...
    protected void processPacket(QuorumPacket qp) throws Exception{
        ...
        case Leader.PROPOSAL:           
            ...
            break;
        // 提交提案，这样对于事务CommitProcessor将放行，由FinalRequestProcessor处理器将事务的改动写入到内存中
        case Leader.COMMIT:
